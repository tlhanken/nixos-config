...
This file provides guidance to AI coding agents (Hermes, Claude, Antigravity, etc.) when working with code in this repository.
...
| `home/profile-*` | `modules/home/` | User profiles: art, development, hermes, productivity |
